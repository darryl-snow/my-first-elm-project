...
Elm.Main.make = function (_elm) {
   ...
   _U.list([A2($Html.h1,_U.list([$Html$Attributes.$class("headline")]),_U.list([$Html.text("Hello World")]))
           ,A2($Html.p,_U.list([]),_U.list([$Html.text("HTML, with qualified imports.")]))]));
